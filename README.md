...
|---------------------|-------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Производительность  | PFR-001           | Время загрузки поста с фотографией по 99п не должно превышать 3 секунды. По 99.9п не должно превышать 5 секунд. Время загрузки должно обеспечиваться при скорости связи не менее 10 мегабит в сек.      |
...
### Прогноз прогноз нагрузки в RPS:
