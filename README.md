...
| Добавление постов мета       | 3650     | 30            | 122                | 117,01             | 500,00          | 0,23                 | 578,70 | 1 000,00  | 0,58           |
...
На основании расчета принято решение использовать один SSD (SATA) объемом 16 терабайт для хранения всех объектов, кроме фото.
